...
function runExit (el, attr, css) {
    ...
    runTransition(
        ...
        css,
        _ => !attr.keep && el.parentNode.removeChild(el)
    )
    return true
}
...
var _move = transitionComponent(function (attr) { 
    return { onupdate: function (el) { return runMove(el, attr) } }
})
...
var Enter = transitionComponent(function (attr) {
    return { oncreate: function (el) { return runEnter(el, attr, attr.css || {}) } }
})
